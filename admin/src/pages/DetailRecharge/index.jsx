...
const DetailTransactionHistory = forwardRef(() => {
  ...
  return (
    <Row className={styles.editUser}>
      <HeaderForm title='Danh sách nạp tiền' />
      <Form className={styles.form} form={form} onFinish={onFinish} name='DetailUser'>
        <Row className={styles.itemForm}>
          ...
          >
            <PasswordInput label='Mật khẩu' require placeholder='Nhập mật khẩu' />
          </Form.Item>
          <Form.Item
            className={styles.rowSearch}
            name='re-password'
            rules={[
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  ...
                  return Promise.reject(new Error('Vui lòng nhập lại mật khẩu giống với mật khẩu ở trên'));
                },
              }),
            ]}
          >
            <PasswordInput label='Nhập lại mật khẩu' require placeholder='Nhập lại mật khẩu' />
          </Form.Item> */}
          <Form.Item
            className={styles.rowSearch}
            name='gender'
